...
class OssRequestSigner {
  ...
  String _getGMTDate(){
    ...
    var dayStr = dateTime.day < 10 ? '0${dateTime.day}' : dateTime.day;
    String result = "$weekDay, $dayStr $month ${dateTime.year} ${_dealIntWithZero(dateTime.hour)}:${_dealIntWithZero(dateTime.minute)}:${_dealIntWithZero(dateTime.second)} GMT";
